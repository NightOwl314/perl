...
*before_libraries = text( "<H4>Libraries</H4>","<hr>");
...
<p><a href="http://www.ActiveState.com" target="_top"><img src="images/aslogo.gif" border="0" width="136" height="60" alt="ActiveState!"></a></p>
HERE
...
<hr>
<img src="images/folder.gif" width="15" height="13" alt="*"> Getting Started<br>
